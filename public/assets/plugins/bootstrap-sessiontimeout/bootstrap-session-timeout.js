...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        var defaults = {
            ...
            keepAliveUrl: 'http://susmx.tk/login/keepAlive',
            ajaxType: 'POST',
            ajaxData: '',
            redirUrl: 'http://susmx.tk/login/lockSession',
            logoutUrl: 'http://susmx.tk/login/salir',
			      loginHome: 'http://susmx.tk/login',
			      sesionVerify: 'http://susmx.tk/login/verifica_session',
            warnAfter: 1000,
            redirAfter: 1200,
