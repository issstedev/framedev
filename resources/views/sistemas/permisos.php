...
<div class="m-portlet m-portlet--tab">
	...
	<input type="hidden" name="role" id="role" value="<?php echo $id_rol; ?>">
		<?php
    ...
    if($metodos){
		foreach ($metodos as $num => $metodo){
			...
			if($printhead == 1){
				...
				$permiso = $roles_data->getPermisos($id_rol,$metodo->id_metodo);
							...
							<div class="well">
								...
								<?php
									...
									for($i=0;$i < count($roles_ck); $i++){
										...
										$acceso = $roles_data->getAccesos($id_rol,$roles_ck[$i]['value'],'fw_roles','fw_roles');
